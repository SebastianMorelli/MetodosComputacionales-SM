//Este código soluciona una ecuación de onda de segundo orden con extremos Libres.
...
int main()
{
    ...
    x[0] = 0;
    x[numpunt] = x[numpunt-1];
    pastWave[0] = 0;
    pastWave[numpunt] = pastWave[numpunt-1];
    presentWave[0] = 0;
    presentWave[numpunt] = presentWave[numpunt-1];
    futureWave[0] = 0;
    futureWave[numpunt] = futureWave[numpunt-1];
